...
*Apart from the Java Collection Framework, the best-known examples of collection frameworks are the C++ Standard Template Library (STL) and Smalltalk's collection hierarchy. Historically, collection frameworks have been quite complex, which gave them a reputation for having a steep learning curve. We believe that the Java Collection Framework breaks with this tradition, as you will learn for yourself in this chapter.*


## Table of Contents
1. [Introduction to Java Collection Framework (JCF)](#introduction-to-java-collection-framework-jcf)
2. [Core Interfaces and Classes](#core-interfaces-and-classes)
    - [List Interface](#list-interface)
    - [Set Interface](#set-interface)
    - [Queue Interface](#queue-interface)
    - [Map Interface](#map-interface)
3. [Specialized Collection](#specialized-collection)
...
## Here is a Roadmap for Learning Java Collection
  1.  **Introduction to Java Collection Framework (JCF)**
...
## Sources and Help
  -  [Java Collection Framework: Official Document](https://docs.oracle.com/javase/tutorial/collections/index.html)
